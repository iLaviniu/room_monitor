...
<html lang="en">
    ...
    <body>
        ...
        <center>
            <div class="container-md">
                <div  class="bg-light" id="passwordResetServerMessagesContainer" <?php print $visibilityErrorMessageDiv; ?>>
                    <?php
    	...
    	<center>
            <div class="container-md">
                <div  class="bg-light" id="passwordResetContainer">
            		<form action="password_reset_redirection.php" onsubmit="return passwordResetFormValidation()" method="post">
            			<label for="username">user</label>
            			<input class="passwordResetInput bg-light" id="username" name="username" type="email">
            			<button class="passwordResetButton" style="margin-top: 15px;">s e n d</button>
            		</form>
                </div>
            </div>
        </center>
